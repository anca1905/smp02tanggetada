...
@section('title', 'Formulir PPDB Online')
@section('header', 'Pendaftaran Peserta Didik Baru')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        @if (session('success'))
            <div class="mb-6 bg-green-50 border border-green-300 rounded-xl p-5 flex items-start gap-4">
                ...
                <div>
                    <p class="font-bold text-green-800 text-sm mb-0.5">Pendaftaran Berhasil!</p>
        ...
        {{-- Flash Error --}}
        @if (session('error'))
            <div class="mb-6 bg-red-50 border border-red-300 rounded-xl p-5">
            ...
            <div class="lg:w-2/3">
                <form id="form-ppdb" action="{{ route('public.ppdb.store') }}" method="POST"
                    ...
                    <div class="bg-blue-900 px-8 py-5 text-white">
                        <h2 class="text-xl font-bold">Formulir Pendaftaran Siswa Baru</h2>
                    ...
                    <div class="p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <div class="bg-blue-50 border border-blue-100 rounded-xl p-5">
                                ...
                                <select name="jurusan" id="jurusan-select" required
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-1.5">
                                        NIK (No. KTP/KIA) <span class="text-red-500">*</span>
                                    </label>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div class="md:col-span-2">
                                    <label class="block text-sm font-semibold text-gray-700 mb-1.5">
                                        Nomor WA / Telepon Aktif <span class="text-red-500">*</span>
                                    </label>
                        ...
                        <div class="pt-2">
                            <button type="submit" id="btn-submit"
                                class="w-full bg-blue-900 text-white font-bold py-4 rounded-xl hover:bg-blue-800 transition shadow-lg flex items-center justify-center gap-2 text-base">
