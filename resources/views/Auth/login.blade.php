...
<head>
    ...
    <title>Login-Yayasan Megatama Jambi</title>
...
<body class="font-poppins">
    ...
    <div class="container mx-auto px-4 py-10 flex-1 flex flex-col items-center justify-center relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
            <div class="login-card admin-tu glass-effect rounded-2xl shadow-xl p-6">
                <div class="text-center mb-6">
                    ...
                    <h2 class="text-xl font-bold gradient-text-secondary mb-1">Admin TU</h2>
                    <p class="text-gray-600 text-sm">Akses untuk mengelola data guru, siswa, ruang, rekap absensi, dan
                        peminjaman ruang.</p>
                </div>

                <form class="space-y-4" id="form-tu" action="{{ route('login.post') }}" method="POST">
                    @csrf
            ...
            <div class="login-card guru glass-effect rounded-2xl shadow-xl p-6">
                <div class="text-center mb-6">
                    ...
                    <p class="text-gray-600 text-sm">Akses untuk melihat riwayat presensi, menginput presensi siswa,
                        dan
                        mengelola kenaikan kelas.</p>
                </div>
                ...
                <form class="space-y-4" action="{{ route('login.post') }}" method="POST">
                    ...
                    <div>
                        <label for="identity-guru"
                            class="block text-sm font-medium text-gray-700 mb-1">ID/Nama</label>
    ...
    <div id="modal"
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-6 max-w-md w-full mx-4 transform transition-all duration-500 scale-95 opacity-0"
            ...
            <div id="modal-body" class="mb-6">
                ...
                <div id="modal-details" class="mt-5 p-4 rounded-xl text-sm "></div>
            </div>
            <div class="text-center">
                <button id="modal-close"
                    class="w-full py-3 px-6 text-base font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all duration-300 hover:shadow-lg text-white">
                    Tutup
                </button>
            </div>
        </div>
