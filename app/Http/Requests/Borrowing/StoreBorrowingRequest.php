...
class StoreBorrowingRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'full_name.max' => 'Nama peminjam tidak boleh lebih dari 100 karakter.',
            ...
            'activity_description.required' => 'Deskripsi kegiatan wajib diisi.',
            'activity_description.string' => 'Deskripsi kegiatan harus berupa string/karakter.',

            'responsible_person.required' => 'Nama penanggung jawab wajib diisi.',
            'responsible_person.string' => 'Nama penanggung jawab harus berupa string/karakter.',
            'responsible_person.max' => 'Nama penanggung jawab tidak boleh lebih dari 100 karakter.',
        ];
    }
}
