...
class StoreTeacherRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            "gender.in" =>
                "Jenis kelamin harus berupa Male (Laki-laki) atau Female (Perempuan)",
            ...
            "homeroom_class.string" =>
                "Kelas ruang guru harus berupa string/karakter",

            "status.required" => "Status harus diisi",
            "status.in" =>
                "Status harus berupa Active (Aktif) atau Inactive (Tidak Aktif)",
