...
class StorePpdbRegistrationRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            "nama_lengkap.string" =>
                "Nama lengkap harus berupa string/karakter.",
            "nama_lengkap.max" =>
                "Nama lengkap tidak boleh lebih dari 100 karakter.",
            ...
            "jenis_kelamin.in" =>
                "Jenis kelamin harus berupa Laki-laki atau Perempuan.",
            ...
            "no_hp.regex" =>
                "Nomor HP harus dalam format Indonesia (08xxxxxxxx atau +628xxxxxx).",

            "asal_sekolah.required" => "Asal sekolah harus diisi.",
            "asal_sekolah.string" =>
                "Asal sekolah harus berupa string/karakter.",
            "asal_sekolah.max" =>
                "Asal sekolah tidak boleh lebih dari 100 karakter.",

            "tempat_lahir.string" =>
                "Tempat lahir harus berupa string/karakter.",
            "tempat_lahir.max" =>
                "Tempat lahir tidak boleh lebih dari 100 karakter.",
