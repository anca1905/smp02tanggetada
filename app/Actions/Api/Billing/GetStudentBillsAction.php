...
namespace App\Actions\Api\Billing;

use App\Models\Bill;
use App\Models\Student;

class GetStudentBillsAction
{
    /**
     * Get student bills and format them.
     */
    public function execute(?Student $student, ?int $studentId = null): array
    {
